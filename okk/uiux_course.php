...
$course_slug = 'ux-ui-fundamentals'; // Example unique slug
$course_title_display = 'UX/UI Design Fundamentals'; // Title from the page
...
<head>
    ...
    <meta name="description" content="Master the principles of user experience and interface design. Learn to create intuitive, beautiful digital products through user research, wireframing, prototyping, and usability testing.">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center">
                 ...
                 <div class="flex items-center space-x-4">
                    ...
                    <div class="hidden md:flex space-x-6">
                        ...
                        <a href="#" class="text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Programs</a>
                        <a href="#" class="text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium">For Business</a>
                        <a href="#" class="text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Resources</a>
                    </div>
                </div>
                 <!-- Right Side Nav -->
                 <div class="flex items-center space-x-4">
                    ...
                    <div class="relative flex items-center">
                         <?php if($user_logged_in): ?>
                            <a href="Dashboard.php" class="flex items-center space-x-2 hover:bg-gray-700 px-1 py-1 rounded-full transition relative" title="Go to Dashboard">
            ...
            <!-- Mobile Menu Content -->
             <div class="mobile-menu hidden md:hidden bg-gray-800 border-t border-gray-700 mt-2">
                 ...
                 <a href="#" class="text-gray-300 hover:text-white">Programs</a>
                 <a href="#" class="text-gray-300 hover:text-white">For Business</a>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-gray-800 rounded-xl p-8 mb-8 border border-gray-700">
            <div class="flex flex-col md:flex-row justify-between">
                <div class="md:w-2/3">
                    ...
                    <p class="text-lg text-gray-300 mb-6">Master the principles of user experience and interface design. Learn to create intuitive, beautiful digital products through user research, wireframing, prototyping, and usability testing.</p>

                    <!-- Ratings/Info (Original) -->
                     <div class="flex flex-wrap items-center gap-4 mb-6"> <div class="flex items-center"> <div class="flex items-center text-yellow-400 mr-1"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></div><span class="text-sm">4.9 (4,250 ratings)</span></div><span class="text-gray-400">•</span><span class="text-sm">58,000+ students enrolled</span><span class="text-gray-400">•</span><span class="text-sm">Updated June 2024</span></div>
        ...
        <div class="bg-gray-800 rounded-xl p-6 mb-8 border border-gray-700">
             <div class="flex justify-between items-center mb-4">
                 ...
                 <!-- Adjust total lessons (4+3+3 = 10) -->
                 <span id="progress-text" class="text-sm text-gray-300">0/10 lessons completed</span>
             </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
            ...
            <div class="lg:col-span-2">
                <div class="bg-gray-800 rounded-xl p-6 border border-gray-700 mb-8" id="curriculum-section"> <!-- Added ID -->
                    ...
                    <div class="mb-8">
                        <div class="flex items-center justify-between mb-4"> <h3 class="text-xl font-semibold text-primary-500">Module 1: UX Design Principles</h3> <span class="text-sm text-gray-400">4 lessons</span> </div>
                        <div class="space-y-3">
                             <div class="flex items-center justify-between bg-gray-700/50 p-4 rounded-lg border border-gray-600"> <div class="flex items-center flex-grow"> <input type="checkbox" id="lesson-1-ux" class="lesson-checkbox hidden"> <label for="lesson-1-ux" class="flex items-center cursor-pointer w-full"> <span class="flex-shrink-0 w-5 h-5 border border-gray-500 rounded mr-4 flex items-center justify-center transition"><i class="fas fa-check text-xs text-primary-600"></i></span> <span class="truncate">Introduction to User Experience Design</span> </label> </div><div class="flex items-center space-x-3 flex-shrink-0 ml-4"> <span class="text-sm text-gray-400">30 min</span> <a href="#" class="text-primary-600 hover:text-secondary-400 text-sm relative has-tooltip"><i class="fas fa-play"></i><span class="tooltip">Start Lesson</span></a> </div></div>
                             <div class="flex items-center justify-between bg-gray-700/50 p-4 rounded-lg border border-gray-600"> <div class="flex items-center flex-grow"> <input type="checkbox" id="lesson-2-ux" class="lesson-checkbox hidden"> <label for="lesson-2-ux" class="flex items-center cursor-pointer w-full"> <span class="flex-shrink-0 w-5 h-5 border border-gray-500 rounded mr-4 flex items-center justify-center transition"><i class="fas fa-check text-xs text-primary-600"></i></span> <span class="truncate">User Research Methods</span> </label> </div><div class="flex items-center space-x-3 flex-shrink-0 ml-4"> <span class="text-sm text-gray-400">45 min</span> <a href="#" class="text-primary-600 hover:text-secondary-400 text-sm relative has-tooltip"><i class="fas fa-play"></i><span class="tooltip">Start Lesson</span></a> </div></div>
                             <div class="flex items-center justify-between bg-gray-700/50 p-4 rounded-lg border border-gray-600"> <div class="flex items-center flex-grow"> <input type="checkbox" id="lesson-3-ux" class="lesson-checkbox hidden"> <label for="lesson-3-ux" class="flex items-center cursor-pointer w-full"> <span class="flex-shrink-0 w-5 h-5 border border-gray-500 rounded mr-4 flex items-center justify-center transition"><i class="fas fa-check text-xs text-primary-600"></i></span> <span class="truncate">Creating User Personas</span> </label> </div><div class="flex items-center space-x-3 flex-shrink-0 ml-4"> <span class="text-sm text-gray-400">40 min</span> <a href="#" class="text-primary-600 hover:text-secondary-400 text-sm relative has-tooltip"><i class="fas fa-play"></i><span class="tooltip">Start Lesson</span></a> </div></div>
                             <div class="flex items-center justify-between bg-gray-700/50 p-4 rounded-lg border border-gray-600"> <div class="flex items-center flex-grow"> <input type="checkbox" id="lesson-4-ux" class="lesson-checkbox hidden"> <label for="lesson-4-ux" class="flex items-center cursor-pointer w-full"> <span class="flex-shrink-0 w-5 h-5 border border-gray-500 rounded mr-4 flex items-center justify-center transition"><i class="fas fa-check text-xs text-primary-600"></i></span> <span class="truncate">Information Architecture</span> </label> </div><div class="flex items-center space-x-3 flex-shrink-0 ml-4"> <span class="text-sm text-gray-400">50 min</span> <a href="#" class="text-primary-600 hover:text-secondary-400 text-sm relative has-tooltip"><i class="fas fa-play"></i><span class="tooltip">Start Lesson</span></a> </div></div>
                        </div>
                    </div>

                    <!-- Module 2 (Original - 3 lessons shown, but header says 5?) -->
                    <div class="mb-8">
                        <div class="flex items-center justify-between mb-4"> <h3 class="text-xl font-semibold text-purple-500">Module 2: UI Design Fundamentals</h3> <span class="text-sm text-gray-400">3 lessons</span> </div> <!-- Corrected count -->
                        <div class="space-y-3">
                            <div class="flex items-center justify-between bg-gray-700/50 p-4 rounded-lg border border-gray-600"> <div class="flex items-center flex-grow"> <input type="checkbox" id="lesson-5-ux" class="lesson-checkbox hidden"> <label for="lesson-5-ux" class="flex items-center cursor-pointer w-full"> <span class="flex-shrink-0 w-5 h-5 border border-gray-500 rounded mr-4 flex items-center justify-center transition"><i class="fas fa-check text-xs text-primary-600"></i></span> <span class="truncate">Visual Design Principles</span> </label> </div><div class="flex items-center space-x-3 flex-shrink-0 ml-4"> <span class="text-sm text-gray-400">35 min</span> <a href="#" class="text-primary-600 hover:text-secondary-400 text-sm relative has-tooltip"><i class="fas fa-play"></i><span class="tooltip">Start Lesson</span></a> </div></div>
                            <div class="flex items-center justify-between bg-gray-700/50 p-4 rounded-lg border border-gray-600"> <div class="flex items-center flex-grow"> <input type="checkbox" id="lesson-6-ux" class="lesson-checkbox hidden"> <label for="lesson-6-ux" class="flex items-center cursor-pointer w-full"> <span class="flex-shrink-0 w-5 h-5 border border-gray-500 rounded mr-4 flex items-center justify-center transition"><i class="fas fa-check text-xs text-primary-600"></i></span> <span class="truncate">Color Theory & Typography</span> </label> </div><div class="flex items-center space-x-3 flex-shrink-0 ml-4"> <span class="text-sm text-gray-400">45 min</span> <a href="#" class="text-primary-600 hover:text-secondary-400 text-sm relative has-tooltip"><i class="fas fa-play"></i><span class="tooltip">Start Lesson</span></a> </div></div>
                            <div class="flex items-center justify-between bg-gray-700/50 p-4 rounded-lg border border-gray-600"> <div class="flex items-center flex-grow"> <input type="checkbox" id="lesson-7-ux" class="lesson-checkbox hidden"> <label for="lesson-7-ux" class="flex items-center cursor-pointer w-full"> <span class="flex-shrink-0 w-5 h-5 border border-gray-500 rounded mr-4 flex items-center justify-center transition"><i class="fas fa-check text-xs text-primary-600"></i></span> <span class="truncate">Design Systems & UI Components</span> </label> </div><div class="flex items-center space-x-3 flex-shrink-0 ml-4"> <span class="text-sm text-gray-400">55 min</span> <a href="#" class="text-primary-600 hover:text-secondary-400 text-sm relative has-tooltip"><i class="fas fa-play"></i><span class="tooltip">Start Lesson</span></a> </div></div>
                        </div>
                    </div>

                    <!-- Module 3 (Original - 3 lessons shown, but header says 5?) -->
                     <div class="mb-8">
                        <div class="flex items-center justify-between mb-4"> <h3 class="text-xl font-semibold text-green-500">Module 3: Wireframing & Prototyping</h3> <span class="text-sm text-gray-400">3 lessons</span> </div> <!-- Corrected count -->
                        <div class="space-y-3">
                            <div class="flex items-center justify-between bg-gray-700/50 p-4 rounded-lg border border-gray-600"> <div class="flex items-center flex-grow"> <input type="checkbox" id="lesson-8-ux" class="lesson-checkbox hidden"> <label for="lesson-8-ux" class="flex items-center cursor-pointer w-full"> <span class="flex-shrink-0 w-5 h-5 border border-gray-500 rounded mr-4 flex items-center justify-center transition"><i class="fas fa-check text-xs text-primary-600"></i></span> <span class="truncate">Low-Fidelity Wireframing</span> </label> </div><div class="flex items-center space-x-3 flex-shrink-0 ml-4"> <span class="text-sm text-gray-400">40 min</span> <a href="#" class="text-primary-600 hover:text-secondary-400 text-sm relative has-tooltip"><i class="fas fa-play"></i><span class="tooltip">Start Lesson</span></a> </div></div>
                            <div class="flex items-center justify-between bg-gray-700/50 p-4 rounded-lg border border-gray-600"> <div class="flex items-center flex-grow"> <input type="checkbox" id="lesson-9-ux" class="lesson-checkbox hidden"> <label for="lesson-9-ux" class="flex items-center cursor-pointer w-full"> <span class="flex-shrink-0 w-5 h-5 border border-gray-500 rounded mr-4 flex items-center justify-center transition"><i class="fas fa-check text-xs text-primary-600"></i></span> <span class="truncate">High-Fidelity Mockups</span> </label> </div><div class="flex items-center space-x-3 flex-shrink-0 ml-4"> <span class="text-sm text-gray-400">50 min</span> <a href="#" class="text-primary-600 hover:text-secondary-400 text-sm relative has-tooltip"><i class="fas fa-play"></i><span class="tooltip">Start Lesson</span></a> </div></div>
                            <div class="flex items-center justify-between bg-gray-700/50 p-4 rounded-lg border border-gray-600"> <div class="flex items-center flex-grow"> <input type="checkbox" id="lesson-10-ux" class="lesson-checkbox hidden"> <label for="lesson-10-ux" class="flex items-center cursor-pointer w-full"> <span class="flex-shrink-0 w-5 h-5 border border-gray-500 rounded mr-4 flex items-center justify-center transition"><i class="fas fa-check text-xs text-primary-600"></i></span> <span class="truncate">Interactive Prototyping</span> </label> </div><div class="flex items-center space-x-3 flex-shrink-0 ml-4"> <span class="text-sm text-gray-400">60 min</span> <a href="#" class="text-primary-600 hover:text-secondary-400 text-sm relative has-tooltip"><i class="fas fa-play"></i><span class="tooltip">Start Lesson</span></a> </div></div>
                        </div>
                    </div>
                ...
                <div class="bg-gray-800 rounded-xl p-6 border border-gray-700">
                       ...
                       <div class="flex flex-col md:flex-row items-start"> <img src="https://randomuser.me/api/portraits/women/44.jpg" class="w-24 h-24 rounded-full object-cover mb-4 md:mb-0 md:mr-6 border-4 border-primary-600/30"> <div> <h3 class="text-xl font-bold mb-1">Sophia Chen</h3> <p class="text-primary-500 mb-3">Lead UX Designer | Google Design Mentor</p><p class="text-gray-300 mb-4 text-sm"> With over 10 years of experience in UX/UI design...</p><div class="flex flex-wrap items-center gap-x-4 gap-y-1 text-sm text-gray-400"> <div class="flex items-center"><i class="fas fa-star text-yellow-400 mr-1"></i><span>4.95 Instructor Rating</span></div><div class="flex items-center"><i class="fas fa-user-graduate mr-1"></i><span>23,500 Students</span></div><div class="flex items-center"><i class="fas fa-play-circle mr-1"></i><span>8 Courses</span></div></div></div></div>
                </div>
            </div>
                ...
                <div class="sticky top-24"> <!-- Adjusted top offset -->
                    ...
                    <div class="bg-gray-800 rounded-xl p-6 border border-gray-700 mb-6 shadow-lg">
                            ...
                            <ul class="space-y-3 text-sm">
                                <li class="flex items-center"><i class="fas fa-video text-primary-600 w-5 text-center mr-3"></i><span>42 hours on-demand video</span></li>
                                ...
                                <li class="flex items-center"><i class="fas fa-project-diagram text-primary-600 w-5 text-center mr-3"></i><span>3 complete design projects</span></li>
                            </ul>
                    </div>
                     <!-- Resources -->
                    <div class="bg-gray-800 rounded-xl p-6 border border-gray-700 mb-6 shadow-lg">
                            ...
                            <div class="space-y-4">
                                <a href="#" class="flex items-center p-3 -m-3 hover:bg-gray-700 rounded-lg transition"> <div class="bg-primary-600/20 text-primary-600 p-2 rounded-lg mr-3 flex-shrink-0 w-10 h-10 flex items-center justify-center"><i class="fas fa-file-pdf"></i></div><div><h4 class="font-medium text-sm">UX Design Checklist</h4><p class="text-xs text-gray-400">PDF • 2.1MB</p></div></a>
                                <a href="#" class="flex items-center p-3 -m-3 hover:bg-gray-700 rounded-lg transition"> <div class="bg-purple-600/20 text-purple-500 p-2 rounded-lg mr-3 flex-shrink-0 w-10 h-10 flex items-center justify-center"><i class="fas fa-palette"></i></div><div><h4 class="font-medium text-sm">UI Design Kit</h4><p class="text-xs text-gray-400">Figma • 8.3MB</p></div></a>
                                <a href="#" class="flex items-center p-3 -m-3 hover:bg-gray-700 rounded-lg transition"> <div class="bg-green-600/20 text-green-500 p-2 rounded-lg mr-3 flex-shrink-0 w-10 h-10 flex items-center justify-center"><i class="fas fa-users"></i></div><div><h4 class="font-medium text-sm">Design Community</h4><p class="text-xs text-gray-400">Slack • 25K+ members</p></div></a>
                            </div>
                    </div>
                     <!-- Related Courses -->
                    <div class="bg-gray-800 rounded-xl p-6 border border-gray-700 shadow-lg">
                          ...
                          <div class="space-y-4">
                              <a href="#" class="flex items-center hover:bg-gray-700 p-3 -m-3 rounded-lg transition"> <img src="https://images.unsplash.com/photo-1555774698-0b77e0d5fac6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=200&q=80" class="w-16 h-12 rounded-lg object-cover mr-3 flex-shrink-0"> <div class="overflow-hidden"><h4 class="font-medium text-sm truncate">Mobile App Design</h4><div class="flex items-center text-xs text-gray-400 mt-1"><i class="fas fa-star text-yellow-400 mr-1"></i><span>4.8 • 5.2k students</span></div></div></a>
                              <a href="#" class="flex items-center hover:bg-gray-700 p-3 -m-3 rounded-lg transition"> <img src="https://images.unsplash.com/photo-1547658719-da2b51169166?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=200&q=80" class="w-16 h-12 rounded-lg object-cover mr-3 flex-shrink-0"> <div class="overflow-hidden"><h4 class="font-medium text-sm truncate">Figma for Beginners</h4><div class="flex items-center text-xs text-gray-400 mt-1"><i class="fas fa-star text-yellow-400 mr-1"></i><span>4.7 • 7.8k students</span></div></div></a>
                          </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // --- Progress & Enrollment Logic ---
             ...
             const totalLessonsForProgress = checkboxes.length > 0 ? checkboxes.length : 10; // Adjusted fallback (4+3+3=10, correct based on module counts)
