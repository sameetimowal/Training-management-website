...
$course_slug = 'data-science-bootcamp-2024'; // Example unique slug
$course_title_display = 'The Complete Data Science Bootcamp 2024'; // Title from the page
...
<head>
    ...
    <meta name="description" content="Master Python, Machine Learning, SQL, and more with our comprehensive data science course. Build real projects and launch your data career.">
                ...
                extend: {
                    colors: {
                        ...
                        secondary: {
                         ...
                         // Keep template's purple if needed for specific elements
                         template_primary: {
                             600: '#7c3aed',
                             700: '#6d28d9',
                             800: '#5b21b6'
                    ...
                    animation: { // Keep animations from template
                        'pulse-slow': 'pulse 3s cubic-bezier(0.4, 0, 0.6, 1) infinite',
                        'float': 'float 6s ease-in-out infinite'
                    },
                    keyframes: { // Keep keyframes from template
                        float: {
...
<body class="bg-gray-900 text-gray-100">
    ...
    <div class="mobile-menu hidden md:hidden bg-gray-800">
         <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
             ...
             <a href="#" class="block px-3 py-2 rounded-md text-base font-medium hover:bg-gray-700">Paths</a>
             <a href="#" class="block px-3 py-2 rounded-md text-base font-medium hover:bg-gray-700">Community</a>
             <a href="#" class="block px-3 py-2 rounded-md text-base font-medium hover:bg-gray-700">For Business</a>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                <div class="bg-gray-800 rounded-xl p-6 shadow-lg">
                    ...
                    <p class="text-gray-400 mt-2 text-lg">Master Python, SQL, Machine Learning, and More | Build Real-World Projects and Launch Your Career</p>

                     <!-- Ratings/Info (Original) -->
                    <div class="flex flex-wrap items-center mt-4 gap-2"> <div class="flex items-center"> <div class="flex items-center text-yellow-400"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i></div><span class="ml-1 text-sm">4.7 (38,500 ratings)</span></div><span class="text-gray-400 text-sm">•</span><span class="text-sm">200,000+ learners</span><span class="text-gray-400 text-sm">•</span><span class="text-sm">Last updated 6/2024</span></div>
                    <div class="flex items-center mt-3"> <span class="text-sm">Created by </span> <a href="#" class="text-secondary-400 hover:underline ml-1 text-sm">Dr. Emily Chen</a><span class="text-sm mx-1">,</span> <a href="#" class="text-secondary-400 hover:underline text-sm">Alex Rodriguez</a> </div>
                    <div class="mt-6"> <div class="flex items-center"><i class="fas fa-globe text-gray-400 mr-2"></i><span class="text-sm">English</span></div><div class="flex items-center mt-2"><i class="fas fa-closed-captioning text-gray-400 mr-2"></i><span class="text-sm">English [Auto], Spanish, French</span></div></div>
                </div>
                ...
                <div class="mt-6 bg-gray-800 rounded-xl p-6 shadow-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 text-sm">
                        <div class="flex items-start"><i class="fas fa-check text-green-500 mt-1 mr-2 flex-shrink-0"></i><span>Master Python for Data Science and Machine Learning</span></div>
                        <div class="flex items-start"><i class="fas fa-check text-green-500 mt-1 mr-2 flex-shrink-0"></i><span>Clean, analyze, and visualize data with Pandas, NumPy, and Matplotlib</span></div>
                        <div class="flex items-start"><i class="fas fa-check text-green-500 mt-1 mr-2 flex-shrink-0"></i><span>Build and deploy Machine Learning models with Scikit-learn and TensorFlow</span></div>
                        <div class="flex items-start"><i class="fas fa-check text-green-500 mt-1 mr-2 flex-shrink-0"></i><span>Write complex SQL queries for data analysis</span></div>
                        <div class="flex items-start"><i class="fas fa-check text-green-500 mt-1 mr-2 flex-shrink-0"></i><span>Work with big data using Spark and Hadoop</span></div>
                        <div class="flex items-start"><i class="fas fa-check text-green-500 mt-1 mr-2 flex-shrink-0"></i><span>Create interactive dashboards with Tableau and Power BI</span></div>
                    </div>
                </div>
                ...
                <div class="mt-6 bg-gray-800 rounded-xl shadow-lg overflow-hidden" id="curriculum-section">
                     ...
                     <div class="divide-y divide-gray-700">
                         <!-- Module 1 --> <div class="accordion-item"> <input type="checkbox" id="module1" class="accordion-toggle hidden"> <label for="module1" class="flex justify-between items-center p-4 hover:bg-gray-700 cursor-pointer"> <div class="flex items-center"> <i class="fas fa-chevron-down accordion-icon transform transition-transform mr-3 text-sm"></i> <span class="font-medium text-sm">Module 1: Python for Data Science</span> </div><span class="text-xs text-gray-400">8 lectures • 4h 15m</span></label> <div class="accordion-content"> <div class="pl-12 pr-4 pb-4 text-sm"> <div class="flex justify-between items-center py-2 border-b border-gray-700/50"><div class="flex items-center text-gray-300"><i class="fas fa-play-circle text-gray-400 mr-3 w-5 text-center"></i><span>Python Fundamentals for Data Science</span></div><span class="text-xs text-gray-400">45m</span></div><div class="flex justify-between items-center py-2 border-b border-gray-700/50"><div class="flex items-center text-gray-300"><i class="fas fa-play-circle text-gray-400 mr-3 w-5 text-center"></i><span>NumPy for Numerical Computing</span></div><span class="text-xs text-gray-400">55m</span></div><div class="flex justify-between items-center py-2 border-b border-gray-700/50"><div class="flex items-center text-gray-300"><i class="fas fa-play-circle text-gray-400 mr-3 w-5 text-center"></i><span>Pandas for Data Manipulation</span></div><span class="text-xs text-gray-400">1h 10m</span></div><div class="flex justify-between items-center py-2 border-b border-gray-700/50"><div class="flex items-center text-gray-300"><i class="fas fa-play-circle text-gray-400 mr-3 w-5 text-center"></i><span>Data Visualization with Matplotlib & Seaborn</span></div><span class="text-xs text-gray-400">50m</span></div><div class="flex justify-between items-center py-2"><div class="flex items-center text-gray-300"><i class="fas fa-laptop-code text-gray-400 mr-3 w-5 text-center"></i><span>Project: Analyze a Real Dataset</span></div><span class="text-xs text-gray-400">1h 35m</span></div></div></div></div>
                         <!-- Module 2 --> <div class="accordion-item"> <input type="checkbox" id="module2" class="accordion-toggle hidden"> <label for="module2" class="flex justify-between items-center p-4 hover:bg-gray-700 cursor-pointer"> <div class="flex items-center"> <i class="fas fa-chevron-down accordion-icon transform transition-transform mr-3 text-sm"></i> <span class="font-medium text-sm">Module 2: Machine Learning Fundamentals</span> </div><span class="text-xs text-gray-400">10 lectures • 5h 30m</span></label> <div class="accordion-content"> <div class="pl-12 pr-4 pb-4 text-sm"> <div class="flex justify-between items-center py-2 border-b border-gray-700/50"><div class="flex items-center text-gray-300"><i class="fas fa-play-circle text-gray-400 mr-3 w-5 text-center"></i><span>Introduction to Machine Learning</span></div><span class="text-xs text-gray-400">40m</span></div><div class="flex justify-between items-center py-2 border-b border-gray-700/50"><div class="flex items-center text-gray-300"><i class="fas fa-play-circle text-gray-400 mr-3 w-5 text-center"></i><span>Supervised Learning Algorithms</span></div><span class="text-xs text-gray-400">1h 20m</span></div><div class="flex justify-between items-center py-2 border-b border-gray-700/50"><div class="flex items-center text-gray-300"><i class="fas fa-play-circle text-gray-400 mr-3 w-5 text-center"></i><span>Unsupervised Learning Techniques</span></div><span class="text-xs text-gray-400">1h 10m</span></div><div class="flex justify-between items-center py-2 border-b border-gray-700/50"><div class="flex items-center text-gray-300"><i class="fas fa-play-circle text-gray-400 mr-3 w-5 text-center"></i><span>Model Evaluation and Validation</span></div><span class="text-xs text-gray-400">45m</span></div><div class="flex justify-between items-center py-2"><div class="flex items-center text-gray-300"><i class="fas fa-laptop-code text-gray-400 mr-3 w-5 text-center"></i><span>Project: Build a Predictive Model</span></div><span class="text-xs text-gray-400">1h 35m</span></div></div></div></div>
                         <!-- Add more modules as needed -->
                     </div>
                     <div class="p-4 text-center border-t border-gray-700"> <button class="text-primary-600 hover:underline text-sm">Show all 14 modules</button> </div> <!-- Use standard blue -->
                </div>
                ...
                <div class="mt-6 bg-gray-800 rounded-xl p-6 shadow-lg">
                      ...
                      <ul class="list-disc list-inside text-gray-300 mt-4 space-y-2 text-sm">
                          <li>No prior programming experience needed (we start from scratch)</li>
                          <li>A computer with internet access (Windows, Mac, or Linux)</li>
                          <li>Basic high school math knowledge</li>
                          <li>Willingness to learn through hands-on projects</li>
                      </ul>
                </div>
                ...
                <div class="mt-6 bg-gray-800 rounded-xl p-6 shadow-lg">
                      ...
                      <div class="mt-4 text-gray-300 space-y-4 text-sm">
                          <p>Welcome to <span class="font-semibold text-primary-500">The Complete Data Science Bootcamp 2024</span>, the most comprehensive...</p> <!-- Use standard blue -->
                          <p>Whether you're a complete beginner looking to start a career...</p>
                          <h3 class="text-xl font-semibold mt-4">Why This Course?</h3>
                          <ul class="list-disc list-inside space-y-2 ml-4"> <li><span class="font-medium">Project-based</span> - Learn by building...</li><li><span class="font-medium">Comprehensive</span> - Covers all essential...</li><li><span class="font-medium">Up-to-date</span> - Includes 2024 tools...</li><li><span class="font-medium">Career-focused</span> - With resume and interview...</li></ul>
                          <h3 class="text-xl font-semibold mt-4">What's Included?</h3>
                          <ul class="list-disc list-inside space-y-2 ml-4"> <li>Lifetime access...</li><li>Downloadable datasets...</li><li>Certificate of completion</li><li>Access to our exclusive data science community</li><li>Regular content updates...</li></ul>
                ...
                <div class="mt-6 bg-gray-800 rounded-xl p-6 shadow-lg">
                       ...
                       <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                           <!-- Instructor 1 --> <div class="flex items-start"> <img src="https://randomuser.me/api/portraits/women/68.jpg" alt="Dr. Emily Chen" class="w-20 h-20 rounded-full object-cover border-2 border-primary-600"> <div class="ml-4"> <h3 class="text-xl font-bold">Dr. Emily Chen</h3> <p class="text-gray-400 text-sm">Data Science Professor & Researcher</p><div class="flex items-center mt-2"><div class="flex items-center text-yellow-400 text-xs"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></div><span class="ml-2 text-xs">4.9 Instructor Rating</span></div><div class="flex items-center mt-1 text-xs"><i class="fas fa-user-graduate text-gray-400 mr-2 w-4 text-center"></i><span>180,000+ Students</span></div><div class="flex items-center mt-1 text-xs"><i class="fas fa-play-circle text-gray-400 mr-2 w-4 text-center"></i><span>9 Courses</span></div><p class="mt-3 text-gray-300 text-xs">Dr. Chen holds a PhD...</p><div class="flex space-x-3 mt-3"><a href="#" class="text-gray-400 hover:text-secondary-400 text-lg"><i class="fab fa-linkedin"></i></a> <a href="#" class="text-gray-400 hover:text-secondary-400 text-lg"><i class="fab fa-twitter"></i></a> <a href="#" class="text-gray-400 hover:text-secondary-400 text-lg"><i class="fas fa-globe"></i></a></div></div></div>
                           <!-- Instructor 2 --> <div class="flex items-start"> <img src="https://randomuser.me/api/portraits/men/75.jpg" alt="Alex Rodriguez" class="w-20 h-20 rounded-full object-cover border-2 border-primary-600"> <div class="ml-4"> <h3 class="text-xl font-bold">Alex Rodriguez</h3> <p class="text-gray-400 text-sm">Senior Data Scientist</p><div class="flex items-center mt-2"><div class="flex items-center text-yellow-400 text-xs"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i></div><span class="ml-2 text-xs">4.7 Instructor Rating</span></div><div class="flex items-center mt-1 text-xs"><i class="fas fa-user-graduate text-gray-400 mr-2 w-4 text-center"></i><span>150,000+ Students</span></div><div class="flex items-center mt-1 text-xs"><i class="fas fa-play-circle text-gray-400 mr-2 w-4 text-center"></i><span>6 Courses</span></div><p class="mt-3 text-gray-300 text-xs">Alex has worked as a data scientist...</p><div class="flex space-x-3 mt-3"><a href="#" class="text-gray-400 hover:text-secondary-400 text-lg"><i class="fab fa-linkedin"></i></a> <a href="#" class="text-gray-400 hover:text-secondary-400 text-lg"><i class="fab fa-twitter"></i></a> <a href="#" class="text-gray-400 hover:text-secondary-400 text-lg"><i class="fas fa-globe"></i></a></div></div></div>
                       </div>
                </div>
                ...
                <div class="mt-6 bg-gray-800 rounded-xl p-6 shadow-lg">
                      ...
                      <div class="mt-4 flex flex-col md:flex-row items-center"> <div class="text-center md:text-left md:mr-8"> <div class="text-5xl font-bold text-primary-500">4.7</div><div class="flex justify-center md:justify-start mt-1"><div class="flex items-center text-yellow-400"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i></div></div><div class="text-sm mt-1 text-gray-400">Course Rating</div></div><div class="w-full mt-4 md:mt-0"> <div class="flex items-center text-xs"><span class="w-10">5 star</span><div class="flex-1 mx-2 h-2 bg-gray-700 rounded-full overflow-hidden"><div class="h-full bg-yellow-400" style="width: 70%"></div></div><span class="w-10 text-right">70%</span></div><div class="flex items-center mt-1 text-xs"><span class="w-10">4 star</span><div class="flex-1 mx-2 h-2 bg-gray-700 rounded-full overflow-hidden"><div class="h-full bg-yellow-400" style="width: 22%"></div></div><span class="w-10 text-right">22%</span></div><div class="flex items-center mt-1 text-xs"><span class="w-10">3 star</span><div class="flex-1 mx-2 h-2 bg-gray-700 rounded-full overflow-hidden"><div class="h-full bg-yellow-400" style="width: 5%"></div></div><span class="w-10 text-right">5%</span></div><div class="flex items-center mt-1 text-xs"><span class="w-10">2 star</span><div class="flex-1 mx-2 h-2 bg-gray-700 rounded-full overflow-hidden"><div class="h-full bg-yellow-400" style="width: 2%"></div></div><span class="w-10 text-right">2%</span></div><div class="flex items-center mt-1 text-xs"><span class="w-10">1 star</span><div class="flex-1 mx-2 h-2 bg-gray-700 rounded-full overflow-hidden"><div class="h-full bg-yellow-400" style="width: 1%"></div></div><span class="w-10 text-right">1%</span></div></div></div>
                      <div class="mt-8"> <h3 class="text-lg font-semibold">Reviews</h3> <div class="space-y-6 mt-4"> <!-- Review 1 --> <div class="border-b border-gray-700 pb-6"> <div class="flex items-center"> <img src="https://randomuser.me/api/portraits/women/33.jpg" alt="Priya K." class="w-10 h-10 rounded-full"> <div class="ml-3"> <div class="font-medium text-sm">Priya K.</div><div class="flex items-center text-xs text-gray-400"><div class="flex items-center text-yellow-400 mr-1 text-xs"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></div><span>4 months ago</span></div></div></div><div class="mt-3 text-sm"> <h4 class="font-semibold text-base">Got me my first data science job!</h4> <p class="text-gray-300 mt-1">This course completely changed my career...</p></div></div><!-- Review 2 --> <div class="border-b border-gray-700 pb-6"> <div class="flex items-center"> <img src="https://randomuser.me/api/portraits/men/45.jpg" alt="David M." class="w-10 h-10 rounded-full"> <div class="ml-3"> <div class="font-medium text-sm">David M.</div><div class="flex items-center text-xs text-gray-400"><div class="flex items-center text-yellow-400 mr-1 text-xs"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i></div><span>2 months ago</span></div></div></div><div class="mt-3 text-sm"> <h4 class="font-semibold text-base">Best data science course available</h4> <p class="text-gray-300 mt-1">I've taken several data science courses before...</p></div></div></div> <button class="mt-6 text-primary-600 hover:underline text-sm">See all 8,750 reviews</button> </div> <!-- Use standard blue -->
                </div>
            </div>
            ...
            <div class="lg:col-span-1">
                <div class="sticky top-20">
                    ...
                    <div class="bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-700">
                        <div class="relative">
                             <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80" alt="<?php safe_echo($course_title_display); ?>" class="w-full h-48 object-cover">
                        ...
                        <div class="p-6">
                            ...
                            <div class="mt-6">
                                ...
                                <ul class="mt-3 space-y-2 text-sm">
                                     ...
                                     <li class="flex items-center"><i class="fas fa-file-alt text-gray-400 mr-2 w-4 text-center"></i><span>45 articles</span></li>
                                     <li class="flex items-center"><i class="fas fa-download text-gray-400 mr-2 w-4 text-center"></i><span>50 downloadable resources</span></li>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
         ...
         <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
             <!-- Course 1 --> <div class="bg-gray-800 rounded-xl shadow-lg overflow-hidden course-card transition duration-300"><img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80" alt="Machine Learning Course" class="w-full h-40 object-cover"><div class="p-4"> <h3 class="font-bold text-base">Machine Learning A-Z with Python</h3> <div class="flex items-center mt-1"><div class="flex items-center text-yellow-400 text-xs"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i></div><span class="ml-2 text-xs text-gray-400">(18,320)</span></div><div class="flex items-center justify-between mt-3"><span class="font-bold text-sm">₹799</span><span class="text-xs text-gray-400 line-through">₹3,999</span></div></div></div>
             <!-- Course 2 --> <div class="bg-gray-800 rounded-xl shadow-lg overflow-hidden course-card transition duration-300"><img src="https://images.unsplash.com/photo-1620712943543-bcc4688e7485?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80" alt="Python Course" class="w-full h-40 object-cover"><div class="p-4"> <h3 class="font-bold text-base">Python for Data Science and AI</h3> <div class="flex items-center mt-1"><div class="flex items-center text-yellow-400 text-xs"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></div><span class="ml-2 text-xs text-gray-400">(25,450)</span></div><div class="flex items-center justify-between mt-3"><span class="font-bold text-sm">₹499</span><span class="text-xs text-gray-400 line-through">₹2,499</span></div></div></div>
             <!-- Course 3 --> <div class="bg-gray-800 rounded-xl shadow-lg overflow-hidden course-card transition duration-300"><img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80" alt="Data Visualization Course" class="w-full h-40 object-cover"><div class="p-4"> <h3 class="font-bold text-base">Data Visualization with Tableau & Power BI</h3> <div class="flex items-center mt-1"><div class="flex items-center text-yellow-400 text-xs"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i></div><span class="ml-2 text-xs text-gray-400">(12,720)</span></div><div class="flex items-center justify-between mt-3"><span class="font-bold text-sm">₹599</span><span class="text-xs text-gray-400 line-through">₹2,999</span></div></div></div>
         </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="bg-gray-800 rounded-xl shadow-lg overflow-hidden">
            <div class="divide-y divide-gray-700">
                 <!-- FAQ Item 1 --><div class="accordion-item"><input type="checkbox" id="faq1" class="accordion-toggle hidden"><label for="faq1" class="flex justify-between items-center p-6 hover:bg-gray-700 cursor-pointer"><span class="font-medium text-sm">Do I need a math background for this course?</span><i class="fas fa-chevron-down accordion-icon transform transition-transform text-sm"></i></label><div class="accordion-content"><div class="px-6 pb-6 text-gray-300 text-sm"><p>While some math is involved in data science...</p></div></div></div>
                 <!-- FAQ Item 2 --><div class="accordion-item"><input type="checkbox" id="faq2" class="accordion-toggle hidden"><label for="faq2" class="flex justify-between items-center p-6 hover:bg-gray-700 cursor-pointer"><span class="font-medium text-sm">Will this course help me get a job in data science?</span><i class="fas fa-chevron-down accordion-icon transform transition-transform text-sm"></i></label><div class="accordion-content"><div class="px-6 pb-6 text-gray-300 text-sm"><p>Yes! Many of our students have landed data science jobs...</p></div></div></div>
                 <!-- FAQ Item 3 --><div class="accordion-item"><input type="checkbox" id="faq3" class="accordion-toggle hidden"><label for="faq3" class="flex justify-between items-center p-6 hover:bg-gray-700 cursor-pointer"><span class="font-medium text-sm">How is this different from free data science resources?</span><i class="fas fa-chevron-down accordion-icon transform transition-transform text-sm"></i></label><div class="accordion-content"><div class="px-6 pb-6 text-gray-300 text-sm"><p>This course offers a structured, comprehensive curriculum...</p></div></div></div>
                 <!-- FAQ Item 4 --><div class="accordion-item"><input type="checkbox" id="faq4" class="accordion-toggle hidden"><label for="faq4" class="flex justify-between items-center p-6 hover:bg-gray-700 cursor-pointer"><span class="font-medium text-sm">What computer specs do I need for this course?</span><i class="fas fa-chevron-down accordion-icon transform transition-transform text-sm"></i></label><div class="accordion-content"><div class="px-6 pb-6 text-gray-300 text-sm"><p>Any relatively modern computer...</p></div></div></div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // --- Progress & Enrollment Logic ---
             ...
             const totalLessonsForProgress = checkboxes.length > 0 ? checkboxes.length : 20; // Adjust fallback
