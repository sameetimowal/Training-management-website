...
$course_slug = 'cybersecurity-fundamentals'; // Example unique slug
$course_title_display = 'Cybersecurity Fundamentals'; // Title from the page
$is_paid_course = true; // Assume this is paid based on price shown in original template
...
<head>
    ...
    <script>
        // Tailwind configuration (Using standard primary color for consistency)
        tailwind.config = {
            theme: {
                extend: {
                    colors: {
                        primary: { // Using standard blue for consistency across courses
                            600: '#2563eb',
                            700: '#1d4ed8',
                            800: '#1e40af'
                        },
                        secondary: {
                         ...
                         // Keep purple from original template if needed elsewhere
                        template_primary: {
                             600: '#7c3aed',
                             700: '#6d28d9',
                             800: '#5b21b6'
...
<body class="bg-gray-900 text-gray-100">
                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block ml-10">
                        <div class="flex space-x-4">
                            ...
                            <a href="resources.html" class="px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-700">Resources</a>
                        </div>
                    </div>
                </div>
                 <!-- Right Side Nav -->
            ...
            <div class="lg:col-span-2">
                ...
                <div class="mt-6 bg-gray-800 rounded-xl shadow-lg overflow-hidden" id="curriculum-section">
                     ...
                     <div class="divide-y divide-gray-700">
                         <!-- Module 1 --> <div class="accordion-item"> <input type="checkbox" id="module1" class="accordion-toggle hidden"> <label for="module1" class="flex justify-between items-center p-4 hover:bg-gray-700 cursor-pointer"> <div class="flex items-center"> <i class="fas fa-chevron-down accordion-icon transform transition-transform mr-3 text-sm"></i> <span class="font-medium text-sm">Module 1: Introduction to Cybersecurity</span> </div><span class="text-xs text-gray-400">6 lectures • 3h 15m</span></label> <div class="accordion-content"> <div class="pl-12 pr-4 pb-4 text-sm"> <div class="flex justify-between items-center py-2 border-b border-gray-700/50"><div class="flex items-center text-gray-300"><i class="fas fa-play-circle text-gray-400 mr-3 w-5 text-center"></i><span>Cybersecurity Landscape Overview</span></div><span class="text-xs text-gray-400">30m</span></div><div class="flex justify-between items-center py-2 border-b border-gray-700/50"><div class="flex items-center text-gray-300"><i class="fas fa-play-circle text-gray-400 mr-3 w-5 text-center"></i><span>Core Security Principles (CIA Triad)</span></div><span class="text-xs text-gray-400">45m</span></div><div class="flex justify-between items-center py-2 border-b border-gray-700/50"><div class="flex items-center text-gray-300"><i class="fas fa-play-circle text-gray-400 mr-3 w-5 text-center"></i><span>Security Governance and Risk Management</span></div><span class="text-xs text-gray-400">40m</span></div><div class="flex justify-between items-center py-2 border-b border-gray-700/50"><div class="flex items-center text-gray-300"><i class="fas fa-play-circle text-gray-400 mr-3 w-5 text-center"></i><span>Legal and Ethical Considerations</span></div><span class="text-xs text-gray-400">35m</span></div><div class="flex justify-between items-center py-2 border-b border-gray-700/50"><div class="flex items-center text-gray-300"><i class="fas fa-play-circle text-gray-400 mr-3 w-5 text-center"></i><span>Security Standards and Frameworks</span></div><span class="text-xs text-gray-400">25m</span></div><div class="flex justify-between items-center py-2"><div class="flex items-center text-gray-300"><i class="fas fa-laptop-code text-gray-400 mr-3 w-5 text-center"></i><span>Lab: Security Awareness Assessment</span></div><span class="text-xs text-gray-400">1h 20m</span></div></div></div></div>
                         <!-- Module 2 --> <div class="accordion-item"> <input type="checkbox" id="module2" class="accordion-toggle hidden"> <label for="module2" class="flex justify-between items-center p-4 hover:bg-gray-700 cursor-pointer"> <div class="flex items-center"> <i class="fas fa-chevron-down accordion-icon transform transition-transform mr-3 text-sm"></i> <span class="font-medium text-sm">Module 2: Threats and Vulnerabilities</span> </div><span class="text-xs text-gray-400">5 lectures • 2h 45m</span></label> <div class="accordion-content"> <div class="pl-12 pr-4 pb-4 text-sm"> <div class="flex justify-between items-center py-2 border-b border-gray-700/50"><div class="flex items-center text-gray-300"><i class="fas fa-play-circle text-gray-400 mr-3 w-5 text-center"></i><span>Types of Cyber Threats and Attackers</span></div><span class="text-xs text-gray-400">35m</span></div><div class="flex justify-between items-center py-2 border-b border-gray-700/50"><div class="flex items-center text-gray-300"><i class="fas fa-play-circle text-gray-400 mr-3 w-5 text-center"></i><span>Common Attack Vectors and Techniques</span></div><span class="text-xs text-gray-400">45m</span></div><div class="flex justify-between items-center py-2 border-b border-gray-700/50"><div class="flex items-center text-gray-300"><i class="fas fa-play-circle text-gray-400 mr-3 w-5 text-center"></i><span>Malware Analysis and Defense</span></div><span class="text-xs text-gray-400">40m</span></div><div class="flex justify-between items-center py-2 border-b border-gray-700/50"><div class="flex items-center text-gray-300"><i class="fas fa-play-circle text-gray-400 mr-3 w-5 text-center"></i><span>Social Engineering and Phishing</span></div><span class="text-xs text-gray-400">30m</span></div><div class="flex justify-between items-center py-2"><div class="flex items-center text-gray-300"><i class="fas fa-laptop-code text-gray-400 mr-3 w-5 text-center"></i><span>Lab: Analyzing Attack Patterns</span></div><span class="text-xs text-gray-400">1h 15m</span></div></div></div></div>
                         <!-- Add more modules as needed -->
                     </div>
                     <div class="p-4 text-center border-t border-gray-700"> <button class="text-primary-600 hover:underline text-sm">Show all 8 modules</button> </div> <!-- Use standard blue -->
                </div>
                ...
                <div class="mt-6 bg-gray-800 rounded-xl p-6 shadow-lg">
                      ...
                      <div class="mt-4 text-gray-300 space-y-4 text-sm">
                          <p>Welcome to <span class="font-semibold text-primary-500">Cybersecurity Fundamentals 2024</span>, your comprehensive introduction...</p> <!-- Use standard blue -->
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const checkboxes = document.querySelectorAll('.lesson-checkbox'); // Add checkboxes to HTML for this
            const totalLessonsForProgress = checkboxes.length > 0 ? checkboxes.length : 8; // Adjust fallback
