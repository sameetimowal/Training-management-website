...
$course_slug = 'js-mastery-2024'; // Example unique slug
$course_title_display = 'Modern JavaScript Mastery 2024'; // Title from the page
...
<head>
    ...
    <meta name="description" content="Master modern JavaScript (ES6+), TypeScript, React, Node.js and build real-world applications. Go from beginner to advanced JavaScript developer.">
...
<body class="bg-gray-900 text-gray-100">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                <div class="bg-gray-800 rounded-xl p-6 shadow-lg">
                    ...
                    <p class="text-gray-400 mt-2 text-lg">Master ES6+, TypeScript, React, Node.js | Build Real-World Projects | From Beginner to Advanced JavaScript Developer</p>

                    <!-- Ratings/Info (Original) -->
                     <div class="flex flex-wrap items-center mt-4 gap-2"> <div class="flex items-center"> <div class="flex items-center text-yellow-400"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i></div><span class="ml-1 text-sm">4.8 (52,700 ratings)</span></div><span class="text-gray-400 text-sm">•</span><span class="text-sm">280,000+ learners</span><span class="text-gray-400 text-sm">•</span><span class="text-sm">Last updated 5/2024</span></div>
                     <div class="flex items-center mt-3"> <span class="text-sm">Created by </span> <a href="#" class="text-secondary-400 hover:underline ml-1 text-sm">Alex Johnson</a><span class="text-sm mx-1">,</span> <a href="#" class="text-secondary-400 hover:underline text-sm">Sarah Chen</a> </div>
                ...
                <div class="mt-6 bg-gray-800 rounded-xl p-6 shadow-lg">
                     ...
                     <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 text-sm">
                         <div class="flex items-start"><i class="fas fa-check text-green-500 mt-1 mr-2 flex-shrink-0"></i><span>Master modern JavaScript (ES6+) features and syntax</span></div>
                         <div class="flex items-start"><i class="fas fa-check text-green-500 mt-1 mr-2 flex-shrink-0"></i><span>Build applications with React, Node.js, and Express</span></div>
                         <div class="flex items-start"><i class="fas fa-check text-green-500 mt-1 mr-2 flex-shrink-0"></i><span>Work with TypeScript for type-safe JavaScript</span></div>
                         <div class="flex items-start"><i class="fas fa-check text-green-500 mt-1 mr-2 flex-shrink-0"></i><span>Understand asynchronous programming with Promises, Async/Await</span></div>
                         <div class="flex items-start"><i class="fas fa-check text-green-500 mt-1 mr-2 flex-shrink-0"></i><span>Implement testing with Jest and debugging techniques</span></div>
                         <div class="flex items-start"><i class="fas fa-check text-green-500 mt-1 mr-2 flex-shrink-0"></i><span>Deploy full-stack JavaScript applications</span></div>
                     </div>
                </div>
                ...
                <div class="mt-6 bg-gray-800 rounded-xl shadow-lg overflow-hidden" id="curriculum-section">
                     ...
                     <div class="divide-y divide-gray-700">
                          <!-- Module 1 --> <div class="accordion-item"> <input type="checkbox" id="module1" class="accordion-toggle hidden"> <label for="module1" class="flex justify-between items-center p-4 hover:bg-gray-700 cursor-pointer"> <div class="flex items-center"> <i class="fas fa-chevron-down accordion-icon transform transition-transform mr-3 text-sm"></i> <span class="font-medium text-sm">Module 1: JavaScript Fundamentals</span> </div><span class="text-xs text-gray-400">8 lectures • 5h 20m</span></label> <div class="accordion-content"> <div class="pl-12 pr-4 pb-4 text-sm"> <div class="flex justify-between items-center py-2 border-b border-gray-700/50"><div class="flex items-center text-gray-300"><i class="fas fa-play-circle text-gray-400 mr-3 w-5 text-center"></i><span>JavaScript Basics & Syntax</span></div><span class="text-xs text-gray-400">45m</span></div><div class="flex justify-between items-center py-2 border-b border-gray-700/50"><div class="flex items-center text-gray-300"><i class="fas fa-play-circle text-gray-400 mr-3 w-5 text-center"></i><span>Variables, Data Types & Operators</span></div><span class="text-xs text-gray-400">55m</span></div><div class="flex justify-between items-center py-2 border-b border-gray-700/50"><div class="flex items-center text-gray-300"><i class="fas fa-play-circle text-gray-400 mr-3 w-5 text-center"></i><span>Functions & Scope</span></div><span class="text-xs text-gray-400">1h 10m</span></div><div class="flex justify-between items-center py-2 border-b border-gray-700/50"><div class="flex items-center text-gray-300"><i class="fas fa-play-circle text-gray-400 mr-3 w-5 text-center"></i><span>Arrays & Objects</span></div><span class="text-xs text-gray-400">50m</span></div><div class="flex justify-between items-center py-2 border-b border-gray-700/50"><div class="flex items-center text-gray-300"><i class="fas fa-play-circle text-gray-400 mr-3 w-5 text-center"></i><span>DOM Manipulation</span></div><span class="text-xs text-gray-400">40m</span></div><div class="flex justify-between items-center py-2 border-b border-gray-700/50"><div class="flex items-center text-gray-300"><i class="fas fa-play-circle text-gray-400 mr-3 w-5 text-center"></i><span>Events & Event Handling</span></div><span class="text-xs text-gray-400">35m</span></div><div class="flex justify-between items-center py-2"><div class="flex items-center text-gray-300"><i class="fas fa-laptop-code text-gray-400 mr-3 w-5 text-center"></i><span>Project: Interactive Web App</span></div><span class="text-xs text-gray-400">1h 25m</span></div></div></div></div>
                          <!-- Module 2 --> <div class="accordion-item"> <input type="checkbox" id="module2" class="accordion-toggle hidden"> <label for="module2" class="flex justify-between items-center p-4 hover:bg-gray-700 cursor-pointer"> <div class="flex items-center"> <i class="fas fa-chevron-down accordion-icon transform transition-transform mr-3 text-sm"></i> <span class="font-medium text-sm">Module 2: Modern JavaScript (ES6+)</span> </div><span class="text-xs text-gray-400">7 lectures • 4h 45m</span></label> <div class="accordion-content"> <div class="pl-12 pr-4 pb-4 text-sm"> <div class="flex justify-between items-center py-2 border-b border-gray-700/50"><div class="flex items-center text-gray-300"><i class="fas fa-play-circle text-gray-400 mr-3 w-5 text-center"></i><span>Let, Const & Block Scoping</span></div><span class="text-xs text-gray-400">30m</span></div><div class="flex justify-between items-center py-2 border-b border-gray-700/50"><div class="flex items-center text-gray-300"><i class="fas fa-play-circle text-gray-400 mr-3 w-5 text-center"></i><span>Arrow Functions & Template Literals</span></div><span class="text-xs text-gray-400">45m</span></div><div class="flex justify-between items-center py-2 border-b border-gray-700/50"><div class="flex items-center text-gray-300"><i class="fas fa-play-circle text-gray-400 mr-3 w-5 text-center"></i><span>Destructuring & Spread Operator</span></div><span class="text-xs text-gray-400">50m</span></div><div class="flex justify-between items-center py-2 border-b border-gray-700/50"><div class="flex items-center text-gray-300"><i class="fas fa-play-circle text-gray-400 mr-3 w-5 text-center"></i><span>Classes & Modules</span></div><span class="text-xs text-gray-400">1h</span></div><div class="flex justify-between items-center py-2 border-b border-gray-700/50"><div class="flex items-center text-gray-300"><i class="fas fa-play-circle text-gray-400 mr-3 w-5 text-center"></i><span>Promises & Async/Await</span></div><span class="text-xs text-gray-400">1h 10m</span></div><div class="flex justify-between items-center py-2"><div class="flex items-center text-gray-300"><i class="fas fa-laptop-code text-gray-400 mr-3 w-5 text-center"></i><span>Project: Modern JavaScript App</span></div><span class="text-xs text-gray-400">1h 30m</span></div></div></div></div>
                ...
                <div class="mt-6 bg-gray-800 rounded-xl p-6 shadow-lg">
                      ...
                      <ul class="list-disc list-inside text-gray-300 mt-4 space-y-2 text-sm">
                          <li>Basic HTML/CSS knowledge helpful but not required</li>
                          <li>No prior JavaScript experience needed</li>
                          <li>Computer with modern browser and code editor</li>
                ...
                <div class="mt-6 bg-gray-800 rounded-xl p-6 shadow-lg">
                      ...
                      <div class="mt-4 text-gray-300 space-y-4 text-sm">
                          <p>Welcome to <span class="font-semibold text-primary-500">Modern JavaScript Mastery 2024</span>, the most comprehensive...</p> <!-- Use standard blue -->
                          ...
                          <ul class="list-disc list-inside space-y-2 ml-4"> <li>Lifetime access...</li><li>Downloadable code...</li><li>Certificate of completion</li><li>Access to our JavaScript developer community</li><li>Regular content updates...</li></ul>
                          <p class="mt-4">By the end of this course, you'll be able to build modern web applications...</p>
                ...
                <div class="mt-6 bg-gray-800 rounded-xl p-6 shadow-lg">
                       ...
                       <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                           <!-- Instructor 1 --> <div class="flex items-start"> <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="Alex Johnson" class="w-20 h-20 rounded-full object-cover border-2 border-primary-600"> <div class="ml-4"> <h3 class="text-xl font-bold">Alex Johnson</h3> <p class="text-gray-400 text-sm">Senior JavaScript Developer & Educator</p><div class="flex items-center mt-2"><div class="flex items-center text-yellow-400 text-xs"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></div><span class="ml-2 text-xs">4.9 Instructor Rating</span></div><div class="flex items-center mt-1 text-xs"><i class="fas fa-user-graduate text-gray-400 mr-2 w-4 text-center"></i><span>250,000+ Students</span></div><div class="flex items-center mt-1 text-xs"><i class="fas fa-play-circle text-gray-400 mr-2 w-4 text-center"></i><span>12 Courses</span></div><p class="mt-3 text-gray-300 text-xs">Alex has 10+ years of experience...</p><div class="flex space-x-3 mt-3"><a href="#" class="text-gray-400 hover:text-secondary-400 text-lg"><i class="fab fa-linkedin"></i></a> <a href="#" class="text-gray-400 hover:text-secondary-400 text-lg"><i class="fab fa-twitter"></i></a> <a href="#" class="text-gray-400 hover:text-secondary-400 text-lg"><i class="fas fa-globe"></i></a></div></div></div>
                           <!-- Instructor 2 --> <div class="flex items-start"> <img src="https://randomuser.me/api/portraits/women/45.jpg" alt="Sarah Chen" class="w-20 h-20 rounded-full object-cover border-2 border-primary-600"> <div class="ml-4"> <h3 class="text-xl font-bold">Sarah Chen</h3> <p class="text-gray-400 text-sm">TypeScript Expert & Full-Stack Developer</p><div class="flex items-center mt-2"><div class="flex items-center text-yellow-400 text-xs"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i></div><span class="ml-2 text-xs">4.8 Instructor Rating</span></div><div class="flex items-center mt-1 text-xs"><i class="fas fa-user-graduate text-gray-400 mr-2 w-4 text-center"></i><span>180,000+ Students</span></div><div class="flex items-center mt-1 text-xs"><i class="fas fa-play-circle text-gray-400 mr-2 w-4 text-center"></i><span>8 Courses</span></div><p class="mt-3 text-gray-300 text-xs">Sarah is a full-stack developer...</p><div class="flex space-x-3 mt-3"><a href="#" class="text-gray-400 hover:text-secondary-400 text-lg"><i class="fab fa-linkedin"></i></a> <a href="#" class="text-gray-400 hover:text-secondary-400 text-lg"><i class="fab fa-twitter"></i></a> <a href="#" class="text-gray-400 hover:text-secondary-400 text-lg"><i class="fas fa-globe"></i></a></div></div></div>
                       </div>
                </div>
                ...
                <div class="mt-6 bg-gray-800 rounded-xl p-6 shadow-lg">
                      ...
                      <div class="mt-4 flex flex-col md:flex-row items-center"> <div class="text-center md:text-left md:mr-8"> <div class="text-5xl font-bold text-primary-500">4.8</div><div class="flex justify-center md:justify-start mt-1"><div class="flex items-center text-yellow-400"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i></div></div><div class="text-sm mt-1 text-gray-400">Course Rating</div></div><div class="w-full mt-4 md:mt-0"> <div class="flex items-center text-xs"><span class="w-10">5 star</span><div class="flex-1 mx-2 h-2 bg-gray-700 rounded-full overflow-hidden"><div class="h-full bg-yellow-400" style="width: 76%"></div></div><span class="w-10 text-right">76%</span></div><div class="flex items-center mt-1 text-xs"><span class="w-10">4 star</span><div class="flex-1 mx-2 h-2 bg-gray-700 rounded-full overflow-hidden"><div class="h-full bg-yellow-400" style="width: 18%"></div></div><span class="w-10 text-right">18%</span></div><div class="flex items-center mt-1 text-xs"><span class="w-10">3 star</span><div class="flex-1 mx-2 h-2 bg-gray-700 rounded-full overflow-hidden"><div class="h-full bg-yellow-400" style="width: 4%"></div></div><span class="w-10 text-right">4%</span></div><div class="flex items-center mt-1 text-xs"><span class="w-10">2 star</span><div class="flex-1 mx-2 h-2 bg-gray-700 rounded-full overflow-hidden"><div class="h-full bg-yellow-400" style="width: 1%"></div></div><span class="w-10 text-right">1%</span></div><div class="flex items-center mt-1 text-xs"><span class="w-10">1 star</span><div class="flex-1 mx-2 h-2 bg-gray-700 rounded-full overflow-hidden"><div class="h-full bg-yellow-400" style="width: 1%"></div></div><span class="w-10 text-right">1%</span></div></div></div>
                      <div class="mt-8"> <h3 class="text-lg font-semibold">Reviews</h3> <div class="space-y-6 mt-4"> <!-- Review 1 --> <div class="border-b border-gray-700 pb-6"> <div class="flex items-center"> <img src="https://randomuser.me/api/portraits/men/55.jpg" alt="Michael R." class="w-10 h-10 rounded-full"> <div class="ml-3"> <div class="font-medium text-sm">Michael R.</div><div class="flex items-center text-xs text-gray-400"><div class="flex items-center text-yellow-400 mr-1 text-xs"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></div><span>2 months ago</span></div></div></div><div class="mt-3 text-sm"> <h4 class="font-semibold text-base">From zero to job-ready</h4> <p class="text-gray-300 mt-1">I started with zero JavaScript knowledge...</p></div></div><!-- Review 2 --> <div class="border-b border-gray-700 pb-6"> <div class="flex items-center"> <img src="https://randomuser.me/api/portraits/women/62.jpg" alt="Emma L." class="w-10 h-10 rounded-full"> <div class="ml-3"> <div class="font-medium text-sm">Emma L.</div><div class="flex items-center text-xs text-gray-400"><div class="flex items-center text-yellow-400 mr-1 text-xs"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></div><span>3 weeks ago</span></div></div></div><div class="mt-3 text-sm"> <h4 class="font-semibold text-base">Perfect for updating skills</h4> <p class="text-gray-300 mt-1">As a developer who hadn't kept up...</p></div></div></div> <button class="mt-6 text-primary-600 hover:underline text-sm">See all 15,320 reviews</button> </div> <!-- Use standard blue -->
                </div>
            </div>
            ...
            <div class="lg:col-span-1">
                <div class="sticky top-20">
                    ...
                    <div class="bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-700">
                        <div class="relative">
                             <img src="https://images.unsplash.com/photo-1579468118864-1b9ea3c0db4a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80" alt="<?php safe_echo($course_title_display); ?>" class="w-full h-48 object-cover">
                        ...
                        <div class="p-6">
                            <div class="flex items-center justify-between"> <p class="text-2xl font-bold">₹799</p> <div class="text-right"> <p class="text-gray-400 line-through">₹3,999</p> <p class="text-red-500 font-bold">80% off</p> </div></div>
                            ...
                            <div class="mt-6">
                                ...
                                <ul class="mt-3 space-y-2 text-sm">
                                      ...
                                      <li class="flex items-center"><i class="fas fa-download text-gray-400 mr-2 w-4 text-center"></i><span>25 downloadable resources</span></li>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
         ...
         <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
             <!-- Course 1 --> <div class="bg-gray-800 rounded-xl shadow-lg overflow-hidden course-card transition duration-300"><img src="https://images.unsplash.com/photo-1633356122544-f134324a6cee?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80" alt="React Course" class="w-full h-40 object-cover"><div class="p-4"> <h3 class="font-bold text-base">React - The Complete Guide 2024</h3> <div class="flex items-center mt-1"><div class="flex items-center text-yellow-400 text-xs"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></div><span class="ml-2 text-xs text-gray-400">(32,500)</span></div><div class="flex items-center justify-between mt-3"><span class="font-bold text-sm">₹899</span><span class="text-xs text-gray-400 line-through">₹4,499</span></div></div></div>
             <!-- Course 2 --> <div class="bg-gray-800 rounded-xl shadow-lg overflow-hidden course-card transition duration-300"><img src="https://images.unsplash.com/photo-1627398242454-45a1465c2479?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80" alt="Node.js Course" class="w-full h-40 object-cover"><div class="p-4"> <h3 class="font-bold text-base">Node.js, Express & MongoDB Bootcamp</h3> <div class="flex items-center mt-1"><div class="flex items-center text-yellow-400 text-xs"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i></div><span class="ml-2 text-xs text-gray-400">(18,750)</span></div><div class="flex items-center justify-between mt-3"><span class="font-bold text-sm">₹799</span><span class="text-xs text-gray-400 line-through">₹3,999</span></div></div></div>
             <!-- Course 3 --> <div class="bg-gray-800 rounded-xl shadow-lg overflow-hidden course-card transition duration-300"><img src="https://images.unsplash.com/photo-1592609931095-54a2168ae893?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80" alt="TypeScript Course" class="w-full h-40 object-cover"><div class="p-4"> <h3 class="font-bold text-base">TypeScript Masterclass</h3> <div class="flex items-center mt-1"><div class="flex items-center text-yellow-400 text-xs"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i></div><span class="ml-2 text-xs text-gray-400">(12,450)</span></div><div class="flex items-center justify-between mt-3"><span class="font-bold text-sm">₹699</span><span class="text-xs text-gray-400 line-through">₹3,499</span></div></div></div>
         </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
         ...
         <div class="bg-gray-800 rounded-xl shadow-lg overflow-hidden">
             <div class="divide-y divide-gray-700">
                  <!-- FAQ Item 1 --><div class="accordion-item"><input type="checkbox" id="faq1" class="accordion-toggle hidden"><label for="faq1" class="flex justify-between items-center p-6 hover:bg-gray-700 cursor-pointer"><span class="font-medium text-sm">Is this course suitable for complete beginners?</span><i class="fas fa-chevron-down accordion-icon transform transition-transform text-sm"></i></label><div class="accordion-content"><div class="px-6 pb-6 text-gray-300 text-sm"><p>Absolutely! We start from the very basics...</p></div></div></div>
                  <!-- FAQ Item 2 --><div class="accordion-item"><input type="checkbox" id="faq2" class="accordion-toggle hidden"><label for="faq2" class="flex justify-between items-center p-6 hover:bg-gray-700 cursor-pointer"><span class="font-medium text-sm">Does this cover React and Node.js?</span><i class="fas fa-chevron-down accordion-icon transform transition-transform text-sm"></i></label><div class="accordion-content"><div class="px-6 pb-6 text-gray-300 text-sm"><p>Yes! The course includes comprehensive sections...</p></div></div></div>
                  <!-- FAQ Item 3 --><div class="accordion-item"><input type="checkbox" id="faq3" class="accordion-toggle hidden"><label for="faq3" class="flex justify-between items-center p-6 hover:bg-gray-700 cursor-pointer"><span class="font-medium text-sm">How is this different from free tutorials?</span><i class="fas fa-chevron-down accordion-icon transform transition-transform text-sm"></i></label><div class="accordion-content"><div class="px-6 pb-6 text-gray-300 text-sm"><p>This is a structured, comprehensive curriculum...</p></div></div></div>
                  <!-- FAQ Item 4 --><div class="accordion-item"><input type="checkbox" id="faq4" class="accordion-toggle hidden"><label for="faq4" class="flex justify-between items-center p-6 hover:bg-gray-700 cursor-pointer"><span class="font-medium text-sm">Will I be job-ready after this course?</span><i class="fas fa-chevron-down accordion-icon transform transition-transform text-sm"></i></label><div class="accordion-content"><div class="px-6 pb-6 text-gray-300 text-sm"><p>Many students have secured JavaScript developer positions...</p></div></div></div>
             </div>
         </div>
    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // --- Progress & Enrollment Logic ---
             ...
             // Adjust fallback based on actual lesson count if different (8+7 = 15?)
             const totalLessonsForProgress = checkboxes.length > 0 ? checkboxes.length : 15;
